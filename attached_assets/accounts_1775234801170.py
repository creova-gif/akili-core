...
LINKEDIN_ACCOUNTS = {
    "justin_mafie": {
        "label": "Justin Mafie",
        "type": "personal",
        "urn": os.environ.get("LINKEDIN_PERSON_URN", ""),   # urn:li:person:XXXXX
        "token": os.environ.get("LINKEDIN_ACCESS_TOKEN", ""),
    },
    "creova_page": {
        "label": "CREOVA (company page)",
        "type": "company",
        "urn": os.environ.get("LINKEDIN_COMPANY_URN", ""),  # urn:li:organization:XXXXX
        "token": os.environ.get("LINKEDIN_ACCESS_TOKEN", ""),
    },
}
...
# ── CONTENT MIX ───────────────────────────────────────────────
CONTENT_MIX = {
    "music":    0.30,  # CREOVA Music, Sankofa Studio, streams
    "tech":     0.30,  # CREOVA Solutions, 14 products, African tech
    "personal": 0.20,  # Justin Mafie founder journey
    "education":0.20,  # Branding, music production, tech tips
}
